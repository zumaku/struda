/*
Simulasikan untuk memasukkan nama kalian dalam isi queue-nya, screenshot output, kumpul dilentera dengan format gambar.
...
main(){
    ...
    system("CLS");
    cout<<"Masukkan elemen antrian (null = selesai): ";
    cin>>data;
    ...
    do{
        ...
        cout<<"\nMasukkan elemen antrian (null = selesai): ";
        cin>>data;
    } while(data != "null");
